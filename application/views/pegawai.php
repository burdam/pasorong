            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Sistem Informasi Izin Keluar Kantor Ahh Mantap!</h1>
                    ...
                    <div class="container-fluid">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-success">Data Pegawai <?php echo $this->session->userdata('nama'); ?></h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <center><a href="<?= base_url('pegawai/tambah/'); ?>" class="btn btn-primary mb-2">Tambah</a></center>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tfoot>
                                        ...
                                        <tbody>
                                            <?php foreach ($pegawai as $m) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><a href="<?= base_url('pegawai/hapus/'); ?><?= $m['id_user']; ?>" class="btn btn-danger mb-2" onclick="return confirm('Apakah Anda ingin menghapus data ini?');">Hapus</a></center>
                                                    </td>
                                                    <td>
                                                        <center><a href="<?= base_url('pegawai/ubah/'); ?><?= $m['id_user']; ?>" class="btn btn-warning mb-2">Ubah</a></center>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
