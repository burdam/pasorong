                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <button type="submit" class="btn btn-primary float-right" name="tambah">Berangkat</button>
                            <a href="<?= base_url('pegawai'); ?>" class="btn btn-danger mb-2">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
